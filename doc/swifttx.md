...
This mechanism has been integrated into Bitcore-Node-P59 which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/P59-Project/insight-api-p59#web-socket-api](https://github.com/P59-Project/insight-api-p59#web-socket-api) 
* API: [https://github.com/P59-Project/insight-api-p59#swifttx-transactions](https://github.com/P59-Project/insight-api-p59#swifttx-transactions) 
...
By default, the P59 Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the P59 Core daemon:
