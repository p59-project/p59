...
In order to support loading of multiple wallets in p59-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is p59.cpp.
...
Changes to p59.cpp
----------------------
p59.cpp is the entry point into p59-qt, and as such, will require some minor modifications to provide hooks for
