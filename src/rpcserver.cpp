...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* P59 features */
        {"p59", "masternode", &masternode, true, true, false},
        {"p59", "listmasternodes", &listmasternodes, true, true, false},
        {"p59", "getmasternodecount", &getmasternodecount, true, true, false},
        {"p59", "masternodeconnect", &masternodeconnect, true, true, false},
        {"p59", "masternodecurrent", &masternodecurrent, true, true, false},
        {"p59", "masternodedebug", &masternodedebug, true, true, false},
        {"p59", "startmasternode", &startmasternode, true, true, false},
        {"p59", "createmasternodekey", &createmasternodekey, true, true, false},
        {"p59", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"p59", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"p59", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"p59", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"p59", "getmasternodescores", &getmasternodescores, true, true, false},
        {"p59", "mnbudget", &mnbudget, true, true, false},
        {"p59", "preparebudget", &preparebudget, true, true, false},
        {"p59", "submitbudget", &submitbudget, true, true, false},
        {"p59", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"p59", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"p59", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"p59", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"p59", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"p59", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"p59", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"p59", "checkbudgets", &checkbudgets, true, true, false},
        {"p59", "mnsync", &mnsync, true, true, false},
        {"p59", "spork", &spork, true, true, false},
        {"p59", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"p59", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use p59d, or the -server option to p59-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> p59-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:59002/\n";
}
