                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("P59 Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a P59 address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and p59: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About P59 Core"), this);
    aboutAction->setStatusTip(tr("Show information about P59 Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for P59"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your P59 addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified P59 addresses"));
    ...
    openAction->setStatusTip(tr("Open a P59: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the P59 Core help message to get a list with possible P59 command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("P59 Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to P59 network", "", count));
}
...
{
    QString strTitle = tr("P59 Core"); // default title
