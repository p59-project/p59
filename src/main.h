...
static const char * devAddr="PufPti2vZNZMvUmDrZ7tYWXdQ8qqD2F6AZ"; //dev address here
static const int devPaymentForce=177200; //dev payment forced
...
// Dev reward transaction check
bool CheckDevPayTransaction(const CTransaction& tx, int nHeight=0); 
