...
For Windows, the private key was generated by Firep59 running on Gavin's main work machine.
The key and certificate were exported into a separate, passphrase-protected PKCS#12 file, and
then deleted from Firep59's keystore. The exported file is used to sign the Windows setup.exe.
