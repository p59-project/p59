Contributing to P59 Core
============================

The P59 Core project operates an open contributor model where anyone is
...
The following applies to code changes to the P59 Core project, and is not to be
confused with overall P59 Network Protocol consensus changes.

Whether a pull request is merged into P59 Core rests with the project merge
...
Patches that change P59 consensus rules are considerably more involved than
...
Where a patch set proposes to change the P59 consensus, it must have been
...
The project leader is the release manager for each P59 Core release.
